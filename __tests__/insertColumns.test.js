...
test('Insert count columns into this', () => {
	...
	const b = new Matrix(4, 3, new Float64Array([1, 0, 2, 3, 4, 0, 5, 6, 7, 0, 8, 9]))
...
test('Fill inserted columns with newData', () => {
	const a = new Matrix(3, 3, new Float64Array([1, 2, 3, 4, 5, 6, 7, 8, 9]))
	const b = new Matrix(4, 3, new Float64Array([-2, 1, 2, 3, -1, 4, 5, 6, 0, 7, 8, 9]))
...
test('Return and mutate result', () => {
	...
	const c = new Matrix(3, 4, new Float64Array([1, 2, 3, 10, 4, 5, 6, 11, 7, 8, 9, 12]))
