...
test('Remove count columns from this', () => {
	...
	const b = new Matrix(3, 2, new Float64Array([1, 3, 4, 6, 7, 9]))
...
test('Return and mutate result', () => {
	const a = new Matrix(3, 3, new Float64Array([1, 2, 3, 4, 5, 6, 7, 8, 9]))
	const b = new Matrix(3, 2, new Float64Array([0, 0, 0, 0, 0, 0]))
	const c = new Matrix(3, 2, new Float64Array([1, 2, 4, 5, 7, 8]))
